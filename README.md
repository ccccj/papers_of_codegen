...
- [一、大模型汇总（LLMs Summary）](#一大模型汇总llms-summary)
  - [1.1 开源模型](#11-开源模型)
    - [CodeT5: Identifier-aware Unified Pre-trained Encoder-Decoder Models for Code Understanding and Generation](#codet5-identifier-aware-unified-pre-trained-encoder-decoder-models-for-code-understanding-and-generation)
  - [1.2 闭源模型](#12-闭源模型)
    - [PANGU-CODER2: BOOSTING LARGE LANGUAGE MODELS FOR CODE WITH RANKING FEEDBACK](#pangu-coder2-boosting-large-language-models-for-code-with-ranking-feedback)
- [二、Code 论文（Recent Innovative Papers）](#二code-论文recent-innovative-papers)
  - [2.1 模型水印](#21-模型水印)
    - [A Watermark for Large Language Models  【ICML 2023】](#a-watermark-for-large-language-models--icml-2023)
    - [Who Wrote this Code? Watermarking for Code Generation](#who-wrote-this-code-watermarking-for-code-generation)
  - [2.2 code debug](#22-code-debug)
    - [Language Models Can Teach Themselves to Program Better](#language-models-can-teach-themselves-to-program-better)
  - [2.3 tokenization](#23-tokenization)
    - [CODEBPE: INVESTIGATING SUBTOKENIZATION OPTIONS FOR LARGE LANGUAGE MODEL PRETRAINING ON SOURCE CODE  【ICLR 2023】](#codebpe-investigating-subtokenization-options-for-large-language-model-pretraining-on-source-code--iclr-2023)
- [三、评测相关论文（Papers Related to Review）](#三评测相关论文papers-related-to-review)
  - [3.1 评测框架](#31-评测框架)
    - [Is Your Code Generated by ChatGPT Really Correct? Rigorous Evaluation of Large Language Models for Code Generation](#is-your-code-generated-by-chatgpt-really-correct-rigorous-evaluation-of-large-language-models-for-code-generation)
    - [A Simple, Yet Effective Approach to Finding Biases in Code Generation  【ACL 2023】](#a-simple-yet-effective-approach-to-finding-biases-in-code-generation--acl-2023)
- [四、NLP相关论文](#四nlp相关论文)
  - [4.1 基础论文](#41-基础论文)
    - [Transformer : Attention Is All You Need  【NIPS 2017】](#transformer--attention-is-all-you-need--nips-2017)
...
### CodeT5: Identifier-aware Unified Pre-trained Encoder-Decoder Models for Code Understanding and Generation
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2109.00859.pdf)
...
### PANGU-CODER2: BOOSTING LARGE LANGUAGE MODELS FOR CODE WITH RANKING FEEDBACK
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2307.14936.pdf)
...
### A Watermark for Large Language Models  【ICML 2023】
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2301.10226v3.pdf)
...
### Who Wrote this Code? Watermarking for Code Generation
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2305.15060.pdf)
...
### Language Models Can Teach Themselves to Program Better
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2207.14502v4.pdf)
...
## 2.3 tokenization
### CODEBPE: INVESTIGATING SUBTOKENIZATION OPTIONS FOR LARGE LANGUAGE MODEL PRETRAINING ON SOURCE CODE  【ICLR 2023】

  :page_facing_up: [paper](https://arxiv.org/pdf/2308.00683.pdf)
...
### Is Your Code Generated by ChatGPT Really Correct? Rigorous Evaluation of Large Language Models for Code Generation
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2305.01210.pdf)
...
### A Simple, Yet Effective Approach to Finding Biases in Code Generation  【ACL 2023】
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/2211.00609.pdf)

  :date: Mon, 31 Oct 2022
  
  :school: Author Affiliation : University of Warsaw, DeepMind, Google(University of Warsaw)

  该论文提出了一个框架，可用于测试代码生成模型的实际性能。该框架识别代码生成模型可能有用到的线索，然后更改或删除这些线索以测试模型的推理能力。例如，如果向代码生成模型提示 “生成一个将两个数字相加并返回其总和的函数”，则预期的答案应类似于 “return a + b”。但是，如果将函数名称更改为通用的 “func” 标记，则模型无法生成正确的解。这表明该模型可能已从训练数据中 “复制粘贴” 了解决方案，并尚未真正学会如何编程。
...
### Transformer : Attention Is All You Need  【NIPS 2017】
  ...
  :page_facing_up: [paper](https://proceedings.neurips.cc/paper_files/paper/2017/file/3f5ee243547dee91fbd053c1c4a845aa-Paper.pdf)
...
### BERT : Pre-training of Deep Bidirectional Transformers for Language Understanding
  ...
  :page_facing_up: [paper](https://arxiv.org/pdf/1810.04805.pdf)
...
### GPT-1 : Improving Language Understanding by Generative Pre-Training
  ...
  :page_facing_up: [paper](https://www.mikecaptain.com/resources/pdf/GPT-1.pdf)
...
### GPT-2 : Language Models are Unsupervised Multitask Learners
  ...
  :page_facing_up: [paper](https://insightcivic.s3.us-east-1.amazonaws.com/language-models.pdf)
...
### GPT-3 : Language Models are Few-Shot Learners
  ...
  :page_facing_up: [paper](https://proceedings.neurips.cc/paper_files/paper/2020/file/1457c0d6bfcb4967418bfb8ac142f64a-Paper.pdf)
